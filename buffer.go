...
func (b *Buffer) ReaderError() error {
	return nil
}

func (b *Buffer) WriterError() error {
	return nil
}

func (b *Buffer) Delim(delim byte) []byte {
...
func (b *Buffer) ReadPacket(spliter Spliter) []byte {
	return spliter.Read(b)
}

func (b *Buffer) WritePacket(x []byte, spliter Spliter) {
	spliter.Write(b, x)
}
...
func (b *Buffer) ReadVarint() int64 {
	r, n := binary.GetVarint(b.Data[b.ReadPos:])
	b.ReadPos += n
	return r
}

func (b *Buffer) ReadUvarint() uint64 {
	r, n := binary.GetUvarint(b.Data[b.ReadPos:])
	b.ReadPos += n
	return r
}
...
func (b *Buffer) ReadUint16BE() uint16 {
	r := binary.GetUint16BE(b.Data[b.ReadPos:])
	b.ReadPos += 2
	return r
}

func (b *Buffer) ReadUint16LE() uint16 {
	r := binary.GetUint16LE(b.Data[b.ReadPos:])
	b.ReadPos += 2
	return r
}

func (b *Buffer) ReadUint24BE() uint32 {
	r := binary.GetUint24BE(b.Data[b.ReadPos:])
	b.ReadPos += 3
	return r
}

func (b *Buffer) ReadUint24LE() uint32 {
	r := binary.GetUint24LE(b.Data[b.ReadPos:])
	b.ReadPos += 3
	return r
}

func (b *Buffer) ReadUint32BE() uint32 {
	r := binary.GetUint32BE(b.Data[b.ReadPos:])
	b.ReadPos += 4
	return r
}

func (b *Buffer) ReadUint32LE() uint32 {
	r := binary.GetUint32LE(b.Data[b.ReadPos:])
	b.ReadPos += 4
	return r
}

func (b *Buffer) ReadUint40BE() uint64 {
	r := binary.GetUint40BE(b.Data[b.ReadPos:])
	b.ReadPos += 5
	return r
}

func (b *Buffer) ReadUint40LE() uint64 {
	r := binary.GetUint40LE(b.Data[b.ReadPos:])
	b.ReadPos += 5
	return r
}

func (b *Buffer) ReadUint48BE() uint64 {
	r := binary.GetUint48BE(b.Data[b.ReadPos:])
	b.ReadPos += 6
	return r
}

func (b *Buffer) ReadUint48LE() uint64 {
	r := binary.GetUint48LE(b.Data[b.ReadPos:])
	b.ReadPos += 6
	return r
}

func (b *Buffer) ReadUint56BE() uint64 {
	r := binary.GetUint56BE(b.Data[b.ReadPos:])
	b.ReadPos += 7
	return r
}

func (b *Buffer) ReadUint56LE() uint64 {
	r := binary.GetUint56LE(b.Data[b.ReadPos:])
	b.ReadPos += 7
	return r
}

func (b *Buffer) ReadUint64BE() uint64 {
	r := binary.GetUint64BE(b.Data[b.ReadPos:])
	b.ReadPos += 8
	return r
}

func (b *Buffer) ReadUint64LE() uint64 {
	r := binary.GetUint64LE(b.Data[b.ReadPos:])
	b.ReadPos += 8
	return r
}
